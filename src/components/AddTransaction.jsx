...
const AddTransaction = () => {
    ...
    const handleSubmit=e=>{
      ...
      if(text!==""&&amount!=="")addTransaction(newTransaction);
  ...
  return (
    ...
    <div className="d-flex flex-column justify-content-center align-items-center">
        <label htmlFor="text" className="form-label">Enter An Expense: (use a negative sign for a payment made by you)  (use a positive sign for money coming to you)</label>
